...
- Objective: Coordinate worker dependencies
- Scope boundary: bounded approved slice
- Files or modules expected:

## Proof Target
- Required verification: swarm dependency verification
...
- Worker-sized tasks:
- Implement shared contract
- Integrate downstream consumer
- Dependency edges:
- Implement shared contract -> Integrate downstream consumer
