...
export const MANAGED_SCRIPT_FILES = [
  ...
  path.join("commands", "beer-closeout-guard.mjs"),
  path.join("commands", "beer-dependencies.mjs"),
  path.join("commands", "beer-flow-guard.mjs"),
  path.join("commands", "beer-model-profile.mjs"),
  path.join("commands", "beer-orchestrate.mjs"),
  path.join("commands", "beer-planning-gate.mjs"),
  path.join("commands", "beer-preflight.mjs"),
  path.join("commands", "beer-review-guard.mjs"),
  path.join("commands", "beer-status.mjs"),
  path.join("commands", "beer-worker-bootstrap.mjs"),
  ...
  path.join("hooks", "beer-closeout-hook.mjs"),
  path.join("hooks", "beer-pre-edit-hook.mjs"),
  path.join("beer-session", "flow-guard.mjs"),
  path.join("beer-session", "orchestrate.mjs"),
  path.join("beer-session", "worker-bootstrap.mjs"),
  path.join("beer-session", "closeout-guard.mjs"),
  path.join("beer-session", "review-quality-guard.mjs"),
  path.join("beer-state", "core.mjs"),
  path.join("beer-state", "markdown.mjs"),
  path.join("beer-state", "model-profiles.mjs"),
